        ...
        <>
            <section className="min-h-screen w-full flex items-center justify-center pt-24 pb-12 relative overflow-hidden">
                ...
                <div className="absolute inset-x-0 top-20 lg:inset-0 z-0">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-b lg:bg-gradient-to-l from-transparent via-[#FAF8F5]/30 lg:via-[#FAF8F5]/92 to-[#FAF8F5] lg:from-[#FAF8F5] lg:to-[#FAF8F5]/35 z-10 pointer-events-none"></div>
