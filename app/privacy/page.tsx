    ...
    <main className="h-[100dvh] w-full overflow-y-auto bg-slate-950 text-slate-100">
      <section className="container mx-auto px-4 sm:px-6 md:px-8 py-10 sm:py-12 md:py-16 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <h2>13. Contacto</h2>
          <p>Para preguntas o solicitudes sobre privacidad, usa el correo de contacto indicado en la app o sitio (<em>contact.gluepets.app@gmail.com</em>). Sustituye este correo por el tuyo antes de publicar.</p>
        </div>
      </section>
    </main>
  );
